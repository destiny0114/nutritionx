	...
	return (
		<div className="bg-purple-300 shadow-xl rounded-2xl w-full h-auto inline-flex items-center px-4 py-2">
			...
			<div className="food-data mx-5 space-y-1">
				<p className="food-name font-poppins font-bold text-xl text-blue-900">{name}</p>
				<p className="food-description font-poppins font-semibold text-xs text-purple-400">
